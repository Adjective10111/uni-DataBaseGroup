...
CREATE TABLE PLAYED (
    ...
    CONSTRAINT PlayingPlayer_FK
        FOREIGN KEY (Player_NC) REFERENCES PLAYER(National_code),
    CONSTRAINT InMatch_FK
        FOREIGN KEY (Match_id) REFERENCES MATCH(Match_id),

    CONSTRAINT PlayerScore_limit
        CHECK (0 <= Score AND Score <= 10),
